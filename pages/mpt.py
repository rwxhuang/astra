...
fig_scatter = px.scatter(
    ...
    labels={"Portfolio Risk": "Portfolio Risk (std dev.)", "Portfolio Mean Return": "Portfolio Mean Return"},
...
df_bar_normalized = df_bar_normalized.div(df_bar_normalized.sum(axis=1), axis=0) * 100
